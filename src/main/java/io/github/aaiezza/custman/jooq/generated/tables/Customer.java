...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, Long> CUSTOMER_DBID = createField(DSL.name("customer_dbid"), SQLDataType.BIGINT.nullable(false).generatedAlwaysAsIdentity(), this, "");
